...
import { IoArrowRedo, IoDocumentTextOutline } from 'react-icons/io5'
import { MdClear, MdFileDownload } from 'react-icons/md'
                        ...
                        <div className={`${isInResults(file, isResults, search, "flex")} conversation-file`} key={key}>
                            ...
                            <div className="file-tools">
                                <Tooltip content={<p>Ouvrir</p>}>
                                    <button><a href={file.url} target="_blank"><IoArrowRedo /></a></button>
                                </Tooltip>
                                ...
                                {file.userId === uid &&
                                    <Tooltip content={<p>Supprimer</p>}>
                                        <button onClick={() => setWarning(key)}><MdClear /></button>
                                    </Tooltip>
                                }
                            </div>
                        </div>
