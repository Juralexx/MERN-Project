...
const SwiperMostLiked = ({ projects }) => {
    ...
    useEffect(() => {
        const sort = projects.sort((a, b) => { return b.likers.length - a.likers.length })
        setSortedtable(sort)
        setLoading(false)
    }, [isLoading, projects])
    ...
    return (
        <>
            {openModal && <ProjectModal project={project} openModal={openModal} setOpenModal={setOpenModal} />}
            <Swiper
                spaceBetween={20}
                slidesPerView={3}
                navigation={true}
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="home-project-card">
                                <div className="left" style={projectPicture('img/paysage-3.jpg')}>
...
export default SwiperMostLiked;