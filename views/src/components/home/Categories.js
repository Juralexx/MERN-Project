...
const Categories = ({ open, setOpen, setCategory }) => {
    ...
    const classes = {
        main_li: "py-2 pl-5 pr-7 cursor-pointer border-r-2 border-transparent hover:border-primary hover:bg-background_primary_light focus:border-primary",
        active: "py-2 pl-5 pr-7 cursor-pointer border-r-2 border-transparent border-primary bg-background_primary_light focus:border-primary"
    }
    ...
    return (
        open &&
        <div className="absolute top-20 flex bg-background_primary h-auto z-[1500] rounded-xl shadow-xl py-5 text-slate-300" ref={wrapperRef}>
            <ul className="p-0 flex flex-col border-r-[0.01rem] border-slate-700" aria-label="vertical-tab-picker">
            ...
            <div className="p-0 flex flex-col w-[230px] border-r-[0.01rem] border-slate-700">
                {active === 0 && (
                    <>
