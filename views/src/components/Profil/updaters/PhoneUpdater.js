...
const PhoneUpdater = () => {
    ...
    const [phoneUpdater, setPhoneUpdater] = useState();
    const [submitted, setSubmitted] = useState(false);
    const [phone, setPhone] = useState(userData.phone);

    const hidePhoneUpdater = () => {
        setPhoneUpdater()
    }
            ...
            <>
                <div className="user-info-edit">
                    ...
                    <div className="btn-container">
                        <button className="btn btn-primary" onClick={hidePhoneUpdater}>Annuler</button>
                        <button className="btn btn-primary" id="checkphone" disabled onClick={handlePhone}>Enregistrer</button>
                    </div>
                </div>
            </>
        )
            ...
            {(userData.phone === '') ? (
                <>
                    <div className="user-info">
                        <button className="add-btn" onClick={openPhoneUpdater} style={{ display: phoneUpdater ? "none" : "block" }}>
                ...
                <>
                    <div className="user-info">
                        ...
                        <div className="btn-container">
                            <button className="btn btn-primary btn-edit" id="checkout" onClick={openPhoneUpdater} style={{ display: phoneUpdater ? "none" : "block" }}><i className="fas fa-pen"></i></button>
