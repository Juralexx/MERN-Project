...
const TasksList = ({ project, user, isAdmin, isManager, navbar, setNavbar, tasks, showTask, setShowTask, websocket, dispatch, openTaskMenu, setOpenTaskMenu, taskMenu, setUpdateTask, setTask }) => {
    ...
    const closeArray = (array, setArray, key) => {
        if (array.includes(key)) {
            return setArray(array.filter(element => element !== key))
        } else {
            return setArray([...array, key])
        }
    }
